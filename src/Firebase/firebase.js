...
import { getFunctions, 
         httpsCallable  } from 'https://www.gstatic.com/firebasejs/12.15.0/firebase-functions.js'
import { getStorage, 
         ref as sref, 
...
export async function callFunction(name, data, location = "australia-southeast1") {
  let res = null;
